...
该 artifact 是现有 Stage 4 科学工作流的发布证据，不是新的科学证据层级。它保留 L3、L4 不合格、验证差于预声明基线、OD600 语义、无抗生素推断和全部关键警告。精确方法与结果见 [Portfolio case study](../docs/portfolio-case-study.md)，发布验证边界见 [Stage 5 release checklist](../docs/release-checklist.md)。
...
- 当前孔/板身份和独立性记录不足，使留出评价不具备 L4 资格；
